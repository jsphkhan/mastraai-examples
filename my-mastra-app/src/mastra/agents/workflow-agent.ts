/** 
 * This is a sample MAstra Agent that uses a workflow to process a user query.
 * I am simulating a workflow that can set up a calendar event.
*/
...
- workflow: to set up calendar events
...
- Action: Use "workflow" tool to set up a meeting. Ask a follow up question _"Could you please provide John's email address (e.g. john.doe@example.com)?"_.

---

### Query: "Can you schedule an event for me?"
- Action: Use "workflow" tool to set up a meeting. Ask a follow up question _"Could you please provide the email address of the attendees (e.g. john.doe@example.com, jane.smith@example.com)?"_.

---

### Query: "Send an email to john.doe@example.com"
- Action: Use "workflow" tool to send an email to john.doe@example.com
