...
// Step to fetch weather forecast for a given city
...
// Step to plan indoor activities based on weather conditions
...
// define the branching workflow now
const conditionalWorkflow = createWorkflow({
    ...
    steps: [fetchWeather, planActivities, planIndoorActivities],
})
.then(fetchWeather)
.branch([
